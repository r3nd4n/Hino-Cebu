...
const assets = [
  ["hino-300-series-hero.jpg", "hero-commercial-truck", "300SeriesFrontBanner.jpg"],
  ["hino-200-series-card.jpg", "truck-range-200", "200%20(with%20background.jpg"],
  ["hino-300-series-card.jpg", "truck-range-300", "300withbackground.jpg"],
  ["hino-500-series-card.jpg", "truck-range-500", "500withbackground.jpg"],
  ["hino-bus-puv-card.jpg", "truck-range-bus-puv", "BUS%20(with%20background)1.jpg"],
];
...
test("homepage imagery is local, documented, and ready for approved Cebu replacements", async () => {
  ...
  for (const [file, role, source] of assets) {
    ...
    assert.match(manifest, new RegExp(`sourceUrl: "https://www\\.hino\\.com\\.ph/assets/images/.+${source.replaceAll(".", "\\.")}"`));
  }
