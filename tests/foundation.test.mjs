...
const routes = [
  ...
  "src/app/(public)/fleet/page.tsx", "src/app/(public)/financing/page.tsx", "src/app/promotions/page.tsx",
  "src/app/(public)/hino-cebu/page.tsx", "src/app/hino-cebu/customer-deliveries/page.tsx",
  "src/app/guides/page.tsx", "src/app/(public)/contact/page.tsx", "src/app/(public)/quote/page.tsx",
...
test("unverified promotions and deliveries start empty", () => {
  assert.match(readFileSync("src/content/promotions.ts", "utf8"), /promotions: Promotion\[\] = \[\]/);
