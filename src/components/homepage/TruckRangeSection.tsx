...
export function TruckRangeSection() {
  ...
  return (
    <section aria-labelledby="truck-range-heading" className="truck-range" id="trucks">
      ...
      <style jsx>{`
        .truck-range { background: var(--color-muted-surface); padding-block: clamp(3rem, 7vw, 5.5rem); }
        ...
        .truck-card__media { align-items: center; aspect-ratio: 4 / 3; background: #f7f7f5; display: flex; justify-content: center; overflow: hidden; padding: var(--space-md); }
